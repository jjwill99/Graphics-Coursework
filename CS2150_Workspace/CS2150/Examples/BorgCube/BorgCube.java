...
/**
 * This program demonstrates the use of OpenGL to render a spinning textured
 * "Borg Cube" from the science fiction series Star Trek. The sample includes a
 * textured cube, some simple spinning animation for the scene, plus animated
 * material properties
 * 
 * <p>
 * Controls:
 ...
 *
 * <p>
 * Ported to Java including elements from Mark Bernard's LWJGL NeHe samples
 *

...
public class Lab6 extends GraphicsLab
{
    ...
    protected void checkSceneInput()
    {
        ...
        else if(Keyboard.isKeyDown(Keyboard.KEY_S) && risingSunMoon == false){
        	risingSunMoon = true;
        	turnOnSunLight();
        }
    ...
    protected void renderScene()
    {
        ...
        GL11.glPushMatrix();
        {
            ...
            // enable texturing and bind an appropriate texture
            GL11.glEnable(GL11.GL_TEXTURE_2D);
            GL11.glBindTexture(GL11.GL_TEXTURE_2D,timeTexture.getTextureID());
    ...
    private void turnOnSunLight(){
        float diffuse0[]  = { 1.0f,  1.0f, 0.0f, 1.0f};

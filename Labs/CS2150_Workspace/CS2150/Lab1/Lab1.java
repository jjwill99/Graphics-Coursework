...
public class Lab1 extends GraphicsLab
{
    ...
    protected void renderScene()
    {
        ...
        GL11.glPushMatrix();
        {
	        ...
	        drawUnitCube(Colour.RED,Colour.RED,Colour.GREEN,Colour.GREEN,Colour.BLUE,Colour.BLUE);
        }
        GL11.glPopMatrix();
        ...
        {
	        GL11.glTranslatef(0.0f, 1.0f, 0.0f);
	        drawUnitCube(Colour.GREEN,Colour.GREEN, Colour.BLUE,Colour.BLUE,Colour.RED,Colour.RED);
        }
        GL11.glPopMatrix();
    }
    /**
    ...
    protected void setSceneCamera()
    {
        ...
        GLU.gluLookAt(10.0f, 5.0f, 10.0f,   // viewer location        

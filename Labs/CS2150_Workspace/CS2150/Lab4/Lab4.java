...
public class Lab4 extends GraphicsLab
{
    ...
    protected void renderScene()
    {
        ...
        float houseFrontDiffuse[]  = {1f, 1f, 0.4f, 1.0f};
     ...
     // position and scale the house's door relative to the base of the house
        GL11.glTranslatef(0.0f, -2.5f, 0.51f);
        
        // how shiny are the front faces of the door (specular exponent)
        float doorFrontShininess = 20.0f;
        // specular reflection of the front faces of the roof
        float doorFrontSpecular[] = {0.2f, 0.2f, 0.2f, 1.0f};
        // diffuse reflection of the front faces of the roof
        float doorFrontDiffuse[] = {0.6f, 0.3f, 0.0f, 1.0f};
    ...
    public void drawUnitDoor(){
    	Vertex v1 = new Vertex(-0.1f, 0.7f,  0f);
        Vertex v2 = new Vertex(0.1f,  0.7f,  0f);
        Vertex v3 = new Vertex( -0.1f,  0f,  0f);
        Vertex v4 = new Vertex( 0.1f, 0f,  0f);
